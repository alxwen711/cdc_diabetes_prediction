...
The dependencies for this project are everything listed in [environment.yml](https://github.com/alxwen711/cdc_diabetes_prediction/main/environment.yml) as well as the following:

(NOTE: this is to be refined further once the basic environment.yml file is setup)

```
conda (version 25.3.1 or higher)
...
Assuming the initial setup is complete, to run the analysis, navigate to `cdc_diabetes_prediction_analysis.ipynb` in Jupyter Lab. Select the Kernel `cdc_diabetes_prediction`, and then under the `Kernel` menu, click `Restart Kernel and Run All Cells`.

## References

(include source for data here as well with annotation saying such)
